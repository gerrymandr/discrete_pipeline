...
#        for weight in ['w_', '']:
#            for pro in ['pro_', '']:
#                if (pro == 'pro_' and unit == 'b_'):
#                    break
#                else:
#                    if pro + "disc_" + weight + 'perim_' + unit + perc not in df:
#                        df["rank_" + pro + "disc_" + weight + 'perim_' + unit + perc] = df[
#                                pro + "disc_" + weight + 'perim_' + unit + perc].rank(ascending = False)
